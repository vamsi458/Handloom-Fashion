...
<body style="background-color: #F3F4F6;" class="flex items-center justify-center min-h-screen">
    <div class="w-full max-w-sm mx-auto bg-white shadow-xl rounded-lg p-8">
        <h2 class="text-3xl font-extrabold text-center text-blue-600 mb-8">Login to Handloom Fashion</h2>
        ...
        <p class="mt-6 text-center text-gray-600 text-sm">Don’t have an account? <a href="/signup" class="text-blue-500 hover:underline">Sign up</a></p>
    </div>
</body>
</html>
